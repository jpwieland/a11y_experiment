...
RULE_TO_WCAG_CRITERION: dict[str, str] = {
    ...
    # ── eslint-plugin-jsx-a11y (mapeamento completo) ──────────────────────────
    # Fonte: https://github.com/jsx-eslint/eslint-plugin-jsx-a11y#supported-rules
    "jsx-a11y/alt-text":                     "1.1.1",  # Non-text Content (A)
    "jsx-a11y/img-redundant-alt":            "1.1.1",  # Non-text Content (A)
    "jsx-a11y/media-has-caption":            "1.2.2",  # Captions (A)
    "jsx-a11y/heading-has-content":          "1.3.1",  # Info and Relationships (A)
    "jsx-a11y/scope":                        "1.3.1",  # Info and Relationships (A)
    "jsx-a11y/autocomplete-valid":           "1.3.5",  # Identify Input Purpose (AA)
    "jsx-a11y/click-events-have-key-events": "2.1.1",  # Keyboard (A)
    "jsx-a11y/mouse-events-have-key-events": "2.1.1",  # Keyboard (A)
    "jsx-a11y/interactive-supports-focus":   "2.1.1",  # Keyboard (A)
    "jsx-a11y/no-access-key":               "2.1.1",  # Keyboard (A)
    "jsx-a11y/tabindex-no-positive":         "2.4.3",  # Focus Order (A)
    "jsx-a11y/no-autofocus":                "2.4.3",  # Focus Order (A)
    "jsx-a11y/anchor-is-valid":             "2.4.4",  # Link Purpose (AA)
    "jsx-a11y/anchor-has-content":          "2.4.4",  # Link Purpose (AA)
    "jsx-a11y/label-has-associated-control": "3.3.2",  # Labels or Instructions (AA)
    "jsx-a11y/label-has-for":               "3.3.2",  # Labels or Instructions (AA)
    "jsx-a11y/html-has-lang":               "3.1.1",  # Language of Page (A)
    "jsx-a11y/lang":                        "3.1.1",  # Language of Page (A)
    "jsx-a11y/aria-role":                   "4.1.2",  # Name, Role, Value (AA)
    "jsx-a11y/aria-props":                  "4.1.2",  # Name, Role, Value (AA)
    "jsx-a11y/aria-proptypes":              "4.1.2",  # Name, Role, Value (AA)
    "jsx-a11y/aria-unsupported-elements":   "4.1.2",  # Name, Role, Value (AA)
    "jsx-a11y/role-has-required-aria-props": "4.1.2", # Name, Role, Value (AA)
    "jsx-a11y/role-supports-aria-props":    "4.1.2",  # Name, Role, Value (AA)
    "jsx-a11y/no-redundant-roles":          "4.1.2",  # Name, Role, Value (AA)
    "jsx-a11y/prefer-tag-over-role":        "4.1.2",  # Name, Role, Value (AA)
